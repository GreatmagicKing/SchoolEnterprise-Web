...
public class JwtTokenUtils {
    ...
    private static final String SECRET = "zhangjiajun";
    private static final String ISS = "zhangjiajun";
 ...
 // 从token中获取用户名
    public static String getUserRole(String token){
        return getTokenBody(token).get("rol", String.class);
    }
    // 是否已过期
 ...
 // 修改一下创建token的方法
    public static String createToken(String username, String role,String secret, boolean isRememberMe) {
        long expiration = isRememberMe ? EXPIRATION_REMEMBER : EXPIRATION;
        HashMap<String, Object> map = new HashMap<>();
        map.put(ROLE_CLAIMS, role);
        return Jwts.builder()
    ...
    public static String getUserRole(String token,String secret){
        return getTokenBody(token,secret).get("rol", String.class);
    }
    // 是否已过期
