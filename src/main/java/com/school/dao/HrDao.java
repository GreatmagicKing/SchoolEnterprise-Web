...
public interface HrDao {
	...
	* @return 返回问题列表
	*/
	List<QuestionList> getHrQuestionList(@Param("userId") String userId);
	
	/** * 获取学生回答的问题
	* @param userId 学生Id
	* @return 返回问题列表
	*/
	List<QuestionList> getHrAnswerList(@Param("userId") String userId);
	...
	* @return 
	*/
	int setHrRecruit(@Param("recruit") Recruit recruit);
	...
	* @return 
	*/
	int setTeacherRecruit(@Param("recruit") Recruit recruit);
	...
	* @return 
	*/
	int setInterviewR(@Param("interviewR") InterviewR interviewR);
	...
	* @return 
	*/
	int setUserList(@Param("user") User user);
